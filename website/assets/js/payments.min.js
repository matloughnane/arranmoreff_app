...
$( "#ticketPicker" ).change(function() {
	...
	switch(ticket_price) {
	    case "car_family":
	        ...
	        if ( $('#car_details_grid').css('display') == "none") {
	        	// console.log("Testing none");
				document.getElementById("car_details_grid").style.display = "block";
				document.getElementById("car_model_grid").style.display = "block";
	        }
	        if ( $('#car_details_grid').css('display') == "block") {
	    ...
	    case "adult":
	        ...
	        if ( $('#car_details_grid').css('display') == "none") {
				...
				document.getElementById("car_model_grid").style.display = "none";
	        }
	        if ( $('#car_details_grid').css('display') == "block") {
	        	// console.log("Testing block");
				document.getElementById("car_details_grid").style.display = "none";
...
$('#validate_ferry').click( function() {
	...
	document.getElementById("warning_car_model").style.display = "none";
	...
	var input_car_model = document.getElementById('car_model_input').value;
...
function requireInput(input){
	...
	switch(input){
		...
		case "car_details":
			...
			document.getElementById("warning_car_details").innerHTML = "<div class='warning'>Please enter your car reg num.</div>";
			// document.getElementById("warning_errors").innerHTML = "<div class='warning'>Check your details above, then try again.</div>";
	        break;
		case "car_model":
			// console.log("You haven't input a " + input);
			document.getElementById("warning_car_model").style.display = "block"
			document.getElementById("warning_car_model").innerHTML = "<div class='warning'>Please enter your car model.</div>";
			// document.getElementById("warning_errors").innerHTML = "<div class='warning'>Check your details above, then try again.</div>";
	        break;
