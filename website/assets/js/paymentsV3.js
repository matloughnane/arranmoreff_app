...
$( "#ticketPicker" ).change(function() {
	...
	var qty = document.getElementById('qtyPicker').value;
	switch(ticket_price) {
	    case "car_family":
	        document.getElementById("price_grid").style.display = "block";
	        document.getElementById("car_details_grid").style.display = "block";
	        var car_family_price_qty = addZeros(car_family_price * qty);
	        document.getElementById("ticket_price").innerHTML = car_family_price_qty;
	        break;
	    case "car_driver":
	        document.getElementById("price_grid").style.display = "block";
	        document.getElementById("car_details_grid").style.display = "block";
	    ...
	    case "adult":
	        ...
	        document.getElementById("ticket_price").innerHTML = adult_price_qty;
	        break;
	    case "student":
	        document.getElementById("price_grid").style.display = "block";
	        document.getElementById("car_details_grid").style.display = "none";
	        var student_price_qty = addZeros(student_price * qty);
	        document.getElementById("ticket_price").innerHTML = student_price_qty;
	        break;
	    case "child":
	        document.getElementById("price_grid").style.display = "block";
	        document.getElementById("car_details_grid").style.display = "none";
	        var child_price_qty = addZeros(child_price * qty);
	        document.getElementById("ticket_price").innerHTML = child_price_qty;
	        break;
	    case "test":
	        document.getElementById("price_grid").style.display = "block";
	        document.getElementById("car_details_grid").style.display = "none";
	        var test_price_qty = addZeros(test_price * qty);
	        document.getElementById("ticket_price").innerHTML = test_price_qty;
	        break;
	    default:
...
$('#payp_btn').click( function() {
	...
	var ticket_type = document.getElementById('ticketPicker').value;
	var ticket_qty = document.getElementById('qtyPicker').value;
	var input_name = document.getElementById('name_input').value;
	var input_number = document.getElementById('number_input').value;
	var input_car_details = document.getElementById('car_details_input').value;
	var input_special_reqs = document.getElementById('special_reqs').value;
