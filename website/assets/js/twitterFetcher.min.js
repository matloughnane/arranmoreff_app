...
else{t=!0;z=a.domId;k=a.maxTweets;A=a.enableLinks;p=a.showUser;s=a.showTime;B=a.showRetweet;u=a.dateFunction;w=a.customCallback;C=a.showInteraction;D=a.showImages;q=a.linksInNewWindow;var c=document.createElement("script");c.type="text/javascript";c.src="http://cdn.syndication.twimg.com/widgets/timelines/"+a.id+"?&lang="+(a.lang||"en")+"&callback=twitterFetcher.callback&suppress_response_codes=true&rnd="+Math.random();document.getElementsByTagName("head")[0].appendChild(c)}},callback:function(a){var c=
...
(d+='<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to='+n[b]+'" class="twitter_reply_icon"'+(q?' target="_blank">':">")+'<i class="icon-reply"></i>Reply</a><a href="https://twitter.com/intent/retweet?tweet_id='+n[b]+'" class="twitter_retweet_icon"'+(q?' target="_blank">':">")+'<i class="icon-arrows-cw"></i> Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id='+n[b]+'" class="twitter_fav_icon"'+(q?' target="_blank">':">")+"<i class='icon-star'></i>Favorite</a></p>");D&&void 0!==h[b]&&(l=h[b],void 0!==l?(l=l.innerHTML.match(/data-srcset="([A-z0-9%_\.-]+)/i)[0],
